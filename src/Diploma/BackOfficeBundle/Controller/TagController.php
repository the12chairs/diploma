...
use Diploma\BackOfficeBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DiplomaBackOfficeBundle:Tag')->findAll();

        return $this->render('DiplomaBackOfficeBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DiplomaBackOfficeBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DiplomaBackOfficeBundle:Tag')->find($id);
        ...
        return $this->render('DiplomaBackOfficeBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('DiplomaBackOfficeBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
